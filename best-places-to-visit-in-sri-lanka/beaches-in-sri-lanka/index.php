...
<title>Best Beaches to Visit in Sri Lanka 2023 - Lanka Tour Driver</title>
<meta name="description"
  content="Looking for the perfect beach getaway? Look no further than Sri Lanka! Our guide highlights the best beaches on this tropical island paradise.">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <section class="inner-page-header">
    ...
    <div class="page-heading">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="inne-page-title">Best Beaches in Sri Lanka</h1>
            <p class="inner-page-sub-title">Discover the stunning beauty of Sri Lanka's beaches</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p>Sri Lanka has some of the world's most stunning beaches.</p>
          <p>The coastal areas, bathed in sunlight, are a great way to start a new day.
            When relaxing on the beautiful sandy beaches, remember your sunscreen.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="attraction">
            ...
            <p>Other stunning beaches in Sri Lanka to see during your vacation.</p>
            <ul>
              <li>Negombo - Kick back and take it easy for a while.</li>
              <li>Mount Lavinia - Have a passion for scuba and snorkelling?</li>
              <li>Kalpitiya - Let's go to an island together, Dolphins.</li>
              <li>Tangalle - Today is Saturday and Sunday will be free.</li>
              <li>Pasakudah and Kalkudah - Beaches with the glistening, white sand.</li>
              <li>Talalla South - Okay, let's spend the entire day in the water.</li>
              <li>Matara - Visit the old Forts and see what they're like.</li>
              <li>Rekawa - Once more, sea turtles.</li>
              <li>Pottuvil - You’d say “Wow, that's stunning”.</li>
              <li>Casuarina Beach - Something tranquil, at any rate.</li>
              <li>Kahandamodara Beach - Coconut trees appreciate a friendly wave.</li>
              <li>Beruwala Beach - Come, let's take a stroll on this beach of golden sand.</li>
              <li>Batticaloa Beach - It's one of the most pristine beaches around.</li>
