...
<title>Boat Rides in Sri Lanka 2023 | Lanka Tour Driver</title>
<meta name="description"
  content="Experience the beauty of Sri Lanka from a different perspective with boat rides. Enjoy the stunning scenery and wildlife as you glide along the water.">
  ...
  <section class="inner-page-header">
    ...
    <div class="page-heading">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="inne-page-title">Boat Rides in Sri Lanka</h1>
            <p class="inner-page-sub-title">Looking for a unique way to explore Sri Lanka? Try our boat rides!</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
          <div class="attraction">
            ...
            <p>You will have a fantastic time on the water with a skilled boat driver, which you must do while visiting
              Sri Lanka.
              Due to the unique nature of visiting islands and cinnamon plantations, this ecotour will likely be
              experienced only once in a lifetime.
              You can get your feet cleaned by fish and enjoy the massage. With the baby crocodiles gone, we can finally
              meet the mangroves.
            </p>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="attraction">
            <h3>Delft Island</h3>
            <p>Leaving from Jaffana, we have an hour to reach this tiny island populated by Tamils. Sri Lanka's
            ...
            <p>There are less than 5,000 people who make
              their home on this rural island, and they enjoy a unique, simple way of life that has made them famous
              for their extraordinary bio variety and wild horses.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="attraction">
            ...
            <p>To get here, you'll need to board the same ferry that goes to Delft Island, but the trip won't take more
              than 15 minutes.
              All these boat rides are possible thanks to safety procedures, and the sea air and bright sunshine will
              provide a unique hue to the short trip.
            </p>
          </div>
        </div>
      </div>
